...
public class PosStringRenderer extends BaseOperatorRenderer{
	...
	static final Logger logger = LoggerFactory.getLogger(PosStringRenderer.class);
	...
	public String prettyPrint(SQLSkin skin, OperatorPiece piece, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		String str = "SELECT STRPOS("+principalstring+", "+ substring +")"; 
		//"INSTR(CAST("+principalstring+ " AS BINARY("+getExtendedPieces(piece)[0].getSize()+")),"+substring+")";
