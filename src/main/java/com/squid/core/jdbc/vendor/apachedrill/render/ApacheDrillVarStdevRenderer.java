...
public class ApacheDrillVarStdevRenderer extends StddevOperatorRenderer{

	static final Logger logger = LoggerFactory.getLogger(ApacheDrillVarStdevRenderer.class);
