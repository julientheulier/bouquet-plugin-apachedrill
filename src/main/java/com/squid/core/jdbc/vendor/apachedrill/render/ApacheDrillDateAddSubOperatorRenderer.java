 ...
 *
 */
public class ApacheDrillDateAddSubOperatorRenderer
extends DateAddSubOperatorRenderer
{
	static final Logger logger = LoggerFactory.getLogger(ApacheDrillDateAddSubOperatorRenderer.class);

	public ApacheDrillDateAddSubOperatorRenderer(DateAddSubOperatorRenderer.OperatorType builtinType) {
		super(builtinType);
	}
